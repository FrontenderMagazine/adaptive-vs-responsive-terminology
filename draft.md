...
Резиновые макеты еще называют тянущимися (дословно с английского "жидкие", *liquid*, жидкость), так как они принимают размер любого экрана за счет использования процентных показателей для структурных элементов вместо статических в пикселях. 
...
Сейчас мы посмотрим на подходы и стратегии...

### RWD

*Отзывчивый веб-дизайн* был описан впервые [в статье на A List Apart](http://alistapart.com/article/responsive-web-design). Название подхода взято из архитектуры по примеру (??)
