...
Анонс [небольшого веб-сайта][1], позволяющего сравнить
...
В данной короткой статье я постараюсь разложить все по полочкам и объяснить
принципиальную разницу между типами макетов и подходами к веб-разработке.
